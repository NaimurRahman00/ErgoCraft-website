  ...
  return (
    <div>
      <div className="w-full mx-auto h-[240px] md:h-[540px] flex flex-col lg:flex-row items-center overflow-hidden gap-5 lg:gap-10 mt-10 relative ">
        <div className="absolute z-50 bg-gradient-to-r flex flex-col items-start from-black/80 top-0 left-0 right-0 bottom-0 p-20 py-24 rounded-b-2xl">
          <h2 className="text-white text-lg mb-2">Jute & Wood craft</h2>
          <h1 className="font-unbounded text-[4.7rem] leading-[5.5rem] text-white font-bold">Raining offers <br /> for hot summer</h1>
          <p className="text-white text-2xl mt-4">25% off on all products</p>
          <button className="btn rounded-full px-10 font-bold text-base mt-5 border-yellow-500 hover:bg-transparent hover:text-white hover:border-yellow-500 border-2 bg-yellow-500 ">Shop Now</button>
        </div>
